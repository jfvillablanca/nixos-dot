...
-- vim.api.nvim_create_autocmd(vim.opt.showtabline, 0)
...
-- Disable autofold on Markdown files
vim.api.nvim_create_autocmd("BufRead", { pattern = { "*.md" }, command = "setlocal nofoldenable" })
