{
  flake.modules.homeManager.neovim = {
    ...
    neovimInit =
      ...
      then {initLua = rcLua;}
      else {extraLuaConfig = rcLua;};
  in {
    options.myHomeModules.neovim.base16Scheme = lib.mkOption {
      type = lib.types.nullOr lib.types.str;
      default = config.colorScheme.slug or null;
      defaultText = lib.literalExpression "config.colorScheme.slug or null";
      description = ''
        base16 scheme slug for base16-nvim (e.g. "gruvbox-dark-hard").
        Defaults to nix-colors' colorScheme.slug when that module is
        imported, else null. When null, base16-nvim is not loaded and
        neovim keeps its built-in default colorscheme.
      '';
    };
      ...
      programs.neovim = lib.mkMerge [
        {
          ...
          plugins = with pkgs.vimPlugins;
            ...
            ++ lib.optional (cfg.base16Scheme != null) {
              plugin = base16-nvim;
              type = "lua";
              config =
                ''
          ...
          extraPackages = with pkgs; [
            ...
            typescript-language-server # js-related grammars
